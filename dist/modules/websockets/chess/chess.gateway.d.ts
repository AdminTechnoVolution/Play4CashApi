...
export declare class ChessGateway implements OnGatewayInit, OnGatewayConnection, OnGatewayDisconnect, OnModuleInit {
    ...
    private getLang;
    constructor(chessGameModel: Model<ChessGameDocument>, roomModel: Model<any>, userModel: Model<any>, config: ConfigService, roomsGateway: RoomsGateway, redis: any, i18n: I18nService, grace: GracePeriodService, turnDeadlines: TurnDeadlineService, webPush: WebPushService, tournamentMatchService?: TournamentMatchService | undefined);
    onModuleInit(): void;
