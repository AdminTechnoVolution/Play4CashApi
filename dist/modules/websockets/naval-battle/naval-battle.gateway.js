...
let NavalBattleGateway = NavalBattleGateway_1 = class NavalBattleGateway {
    ...
    constructor(placementModel, roomModel, userModel, config, roomsGateway, redis, i18n, grace, turnDeadlines, tournamentMatchService) {
    ...
    onModuleInit() {
        ...
        this.turnDeadlines.registerHandler('naval-battle', (playerId, roomId) => this.executeNavalTurnTimeout(roomId, playerId));
    }
