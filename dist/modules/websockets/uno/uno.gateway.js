...
let UnoGateway = UnoGateway_1 = class UnoGateway {
    ...
    constructor(unoModel, roomModel, userModel, config, roomsGateway, redis, i18n, grace, turnDeadlines) {
    ...
    onModuleInit() {
        ...
        this.turnDeadlines.registerHandler('uno', (playerId, roomId) => this.eliminatePlayer(roomId, playerId, 'timeout'));
    }
