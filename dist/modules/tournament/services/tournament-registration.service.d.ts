...
export declare class TournamentRegistrationService {
    ...
    constructor(tournamentModel: Model<TournamentDocument>, participantModel: Model<TournamentParticipantDocument>, userModel: Model<UserDocument>, ledger: TournamentLedgerService, idempotency: IdempotencyService, tournamentsGateway: TournamentsGateway);
