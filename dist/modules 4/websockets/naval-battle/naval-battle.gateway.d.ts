...
export declare class NavalBattleGateway implements OnGatewayInit, OnGatewayConnection, OnGatewayDisconnect, OnModuleInit {
    ...
    constructor(placementModel: Model<BattleshipPlacementDocument>, roomModel: Model<any>, userModel: Model<any>, config: ConfigService, roomsGateway: RoomsGateway, redis: any, i18n: I18nService, grace: GracePeriodService, tournamentMatchService?: TournamentMatchService | undefined);
    onModuleInit(): void;
