...
export declare class HalmaGateway implements OnGatewayInit, OnGatewayConnection, OnGatewayDisconnect, OnModuleInit {
    ...
    private getLang;
    constructor(halmaModel: Model<HalmaGameDocument>, roomModel: Model<any>, userModel: Model<any>, config: ConfigService, roomsGateway: RoomsGateway, redis: any, i18n: I18nService, grace: GracePeriodService);
    onModuleInit(): void;
