...
let ChessGateway = ChessGateway_1 = class ChessGateway {
    ...
    constructor(chessGameModel, roomModel, userModel, config, roomsGateway, redis, i18n, grace) {
    ...
    async executeForfeit(room_id, player_id) {
        ...
        const grossPayout = (0, game_prize_util_1.winnerGrossPayout)(room.bet_amount, room.house_edge, pc);
